    ...
    const posts:PostData[] = [
        {
            ...
            image:{ title :request.includes.Asset[0].fields.title , url:request.includes.Asset[0].fields.file.url } , 
            id : request.items[0].sys.id , 
        } , 
        {
            fields:request.items[1].fields ,
            image:{ title :request.includes.Asset[1].fields.title , url:request.includes.Asset[1].fields.file.url } , 
